...
public extension Data {
    ...
    func encrypt(using encryptionKey: String = String.random(ofLength: 16), with encoding: String.Encoding = .utf8) -> DHCryptographyHexStore? {
        ...
        do {
            ...
            return DHCryptographyHexStore(cryptKey: encryptionKeyArray.toHexString(), iv: ivArray.toHexString(), cryptValue: encrypted.toHexString())
        } catch {
            return nil
        }
    }
